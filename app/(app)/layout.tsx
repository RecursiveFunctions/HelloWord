  ...
  return (
    <div className="flex min-h-svh flex-col">
      ...
      <div className="min-w-0 flex-1 bg-background has-[[data-full-bleed]]:flex has-[[data-full-bleed]]:h-[calc(100svh-var(--topbar-h))] has-[[data-full-bleed]]:max-h-[calc(100svh-var(--topbar-h))] has-[[data-full-bleed]]:min-h-0 has-[[data-full-bleed]]:flex-col has-[[data-full-bleed]]:overflow-hidden">
        <div className="w-full px-4 py-6 sm:px-6 lg:px-10has-[[data-full-bleed]]:flex has-[[data-full-bleed]]:h-full has-[[data-full-bleed]]:min-h-0 has-[[data-full-bleed]]:flex-1 has-[[data-full-bleed]]:max-w-none has-[[data-full-bleed]]:overflow-hidden has-[[data-full-bleed]]:p-0">
          {children}
        </div>
      </div>
    </div>
